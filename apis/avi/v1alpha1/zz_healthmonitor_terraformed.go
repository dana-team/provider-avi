...
func (tr *HealthMonitor) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"authentication[*].password": "authentication[*].passwordSecretRef", "authentication[*].username": "authentication[*].usernameSecretRef", "radius_monitor[*].password": "radiusMonitor[*].passwordSecretRef", "radius_monitor[*].shared_secret": "radiusMonitor[*].sharedSecretSecretRef"}
}
...
// GetInitParameters of this HealthMonitor
func (tr *HealthMonitor) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
